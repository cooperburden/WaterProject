                ...
                <div id="projectCard" className="card" key={p.projectId} > 
                    ...
                    <div className="card-body">
                        <ul className="list-unstyled">
                            ...
                            <li> <strong>Regional Program: </strong>{p.projectType}</li>
                            <li> <strong>Impact: </strong> {p.projectType} Individuals Served</li>
                            <li> <strong>Project Phase:</strong> {p.projectPhase}</li>
                            <li> <strong>Project Status: </strong>{p.projectFunctionalityStatus}</li>
                        </ul>

                        <button className='btn btn-success' 
                        onClick={() => navigate(`/donate/${p.projectName}/${p.projectId}`) } > Donate </button>
                    </div>
